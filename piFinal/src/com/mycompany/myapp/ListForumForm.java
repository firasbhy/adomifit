 ...
 */
public class ListForumForm extends BaseForm {
    
     Form current;
    public ListForumForm (Resources res) {
    ...
    // appel affichage 
    ArrayList<Forum> list = ServiceForum.getInstance().affichageForum();
    ...
    private void addButton(Image img,Forum p,Resources res) {
     ...
     Label nomText = new Label ("Titre: "+p.getTitre(),"NewsTopLine2");
      Label descriptionText = new Label ("nombres des participantsS: "+p.getNbrparticipants(),"NewsTopLine2");
       ...
       //Label dateText = new Label ("date:"+p.getDate(),"NewsTopLine2");
        ...
        createLineSeparator();
             ...
             dig.dispose();
              ServiceForum.getInstance().deleteForum(p.getId()); 
