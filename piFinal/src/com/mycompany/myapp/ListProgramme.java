 ...
 * @author MSI
 */
public class ListProgramme extends BaseForm {
    ...
    public ListProgramme(Resources res ,CategorieProgramme cat, int id) {
        ...
        ArrayList<Programme> List = serviceProgramme.getInstance().getProgrammes(id);
...
// clear
    ...
    private void addButton( Programme prog, Resources res) {
       ...
       TextArea ta = new TextArea(prog.getTitre());
       TextArea tb = new TextArea(prog.getDescription());
       
       try {
            enc = EncodedImage.create("/load.jpg");
        } catch (Exception e) {
        }
        imgs = URLImage.createToStorage(enc, Statics.URL_REP_IMAGES+"/"+prog.getImage(), Statics.URL_REP_IMAGES+"/"+prog.getImage(),URLImage.RESIZE_SCALE);
       ...
       tb.setUIID("NewTopLine2");
        ...
        tb.setEditable(false);
         ...
         //show button
           ...
           btnaff.addPointerPressedListener((e) -> {
               serviceProgramme.getInstance().abn(prog);
               new StatistiquePieForm2(res,prog).show();
           });
        ...
        //modif button
           ...
           btnModif.addPointerPressedListener((e) -> {
               new ModifierProgrammeForm(res,prog).show();
           });
           //dislike button
         Label btndislike = new Label(" ");
           ...
           btndislike.addPointerPressedListener((e) -> {
               ...
               if(dig.show("Dislike :( "," vous  n'aimez pas ce programme ?" , "non" , "OUI")){
                   ...
                   dig.dispose();
                   if(serviceProgramme.getInstance().jaimepas(prog)){
         ...
         Label btnlike = new Label(" ");
           ...
           btnlike.addPointerPressedListener((e) -> {
               ...
               if(dig.show("Like !","avez vous vraiment aimez ce programme ?" , "non" , "OUI")){
                   ...
                   dig.dispose();
                   if(serviceProgramme.getInstance().jaime(prog)){
           ...
           btnSupp.addPointerPressedListener((e) -> {
               ...
               if(dig.show("Suppression Categorie !","Voulez vous vraiment supprimer cette categorie ?" , "Annuler" , "OK")){
                   ...
                   if(  serviceProgramme.getInstance().deleteProgramme(prog.getId())){
                       new ListCategorieProgramme(res).show();
                   }
                    }
       ...
       addAll(ta,tb,imgv,btnlike,btndislike,btnSupp,btnModif,btnaff);
