...
public class ListProduit extends BaseForm {
    ...
    public ListProduit(Resources res) {
        ...
        RadioButton mesListes = RadioButton.createToggle("Liste Produit", barGroup);
        ...
        mesListes.addActionListener(e-> new ListProduit(res).show());
       partage.addActionListener(e-> new AjoutProduitForm(res).show());
        ...
        ArrayList<Produit> List = serviceProduit.getInstance().getAllProduit();
        
        for (Produit cat : List){
                addButton(cat,res);
    ...
    private void addButton( Produit cat, Resources res) {
         
          
        
       TextArea ta = new TextArea(cat.getNom());
       ...
       imgv.setUIID("NewTopLine2");
        ...
        tb.setEditable(false);
         ...
         //modif cmnd
              ...
              Label btncmnd = new Label(" ");
           btncmnd.setUIID("NewsBottomLine");
           Style cmndstyle = new Style(btncmnd.getUnselectedStyle());
           cmndstyle.setFgColor(0x0000ff);
           
           FontImage cmnd = FontImage.createMaterial(FontImage.MATERIAL_SHOPPING_CART, cmndstyle);
           btncmnd.setIcon(cmnd);
           btncmnd.setTextPosition(LEFT);
           
           btncmnd.addPointerPressedListener((e) -> {
                             //appel service 
                      
                     Message m = new Message("Votre Produit  est ajouté avec sucées,\nVeuillez entrer le code de localisation pour recever votre commande:(        ) \"");
                   String textAttachmentUri = "Adomifit";
                    m.getAttachments().put(textAttachmentUri, "text/plain");
                    Display.getInstance().sendMessage(new String[]{/*mail l user a faire*/"trabelsiaboud6666@gmail.com"}, "felicitation", m);
        ...
        //modif button
           ...
           btnModif.addPointerPressedListener((e) -> {
               new ModifierProduitForm(res,cat).show();
           });
         ...
         Label btndislike = new Label(" ");
           ...
           btndislike.addPointerPressedListener((e) -> {
               ...
               if(dig.show("Dislike 🙁 "," vous  n'aimez pas ce programme ?" , "non" , "OUI")){
                   ...
                   dig.dispose();
                   if(serviceProduit.getInstance().jaimepas(cat)){
         ...
         Label btnlike = new Label(" ");
           ...
           btnlike.addPointerPressedListener((e) -> {
               ...
               if(dig.show("Like !","avez vous vraiment aimez ce programme ?" , "non" , "OUI")){
                   ...
                   dig.dispose();
                   if(serviceProduit.getInstance().jaime(cat)){
           ...
           btnSupp.addPointerPressedListener((e) -> {
               ...
               if(dig.show("Suppression Categorie !","Voulez vous vraiment supprimer cette categorie ?" , "Annuler" , "OK")){
                   ...
                   dig.dispose();
                   if(serviceProduit.getInstance().deleteProduit(cat.getId())){
                       new ListProduit(res).show();
                   }
                    }
       ...
       addAll(ta,tb,imgv,btnSupp,btnModif,btncmnd,btndislike,btnlike);
