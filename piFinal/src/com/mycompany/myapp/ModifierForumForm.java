 ...
 * @author Lenovo
 */
public class ModifierForumForm extends BaseForm {
    
    Form current;
    public ModifierForumForm(Resources res , Forum c) {
        super ("Newsfeed",BoxLayout.y());
    Toolbar tb = new Toolbar(true);
    current = this;    setToolbar(tb);
    ...
    //
     ...
     swipe.setUIID("Container");
       ...
       ajout.setUIID("SelectBar");
        ...
        TextField objet = new TextField(String.valueOf(c.getTitre()), "", 20 , TextField.ANY);
...
/*           if(etatCombo.getSelectedIndex() == 0 ) {
       ...
       if(ServiceForum.getInstance().modifierForum(c)) { // if true
    ...
    private void addButton(Image img,Forum p,Resources res) {
     ...
     Label nomText = new Label ("Titre: "+p.getTitre(),"NewsTopLine2");
   //   Label descriptionText = new Label ("nbr participants: "+p.getNbrparticipants(),"NewsTopLine2");
       ...
       //Label dateText = new Label ("date:"+p.getDate(),"NewsTopLine2");
        ...
        createLineSeparator();
           ...
           lModifier.setUIID("NewsTopLine2");
            ...
            new ModifierForumForm(res,p).show();
