 ...
 * @author Kouki
 */
public class RechercheRegime extends BaseForm {
     EncodedImage enc;
      Image imgs;
      ImageViewer imgv;

    public RechercheRegime(Resources res ,  ArrayList<Regime>  ListRecherche) {
        ...
        RadioButton ListeRegime = RadioButton.createToggle("ListeRegime", barGroup);
        ListeRegime.setUIID("SelectBar");
       ListeRegime.addActionListener(e-> new ListRegimesForm(res).show());
         RadioButton Resultat = RadioButton.createToggle("Featured", barGroup);
        Resultat.setUIID("SelectBar");
        Label arrow = new Label(res.getImage("news-tab-down-arrow.png"), "Container");
        add(LayeredLayout.encloseIn(
                GridLayout.encloseIn(2, ListeRegime, Resultat),
        ...
        addShowListener(e -> {
            ...
            updateArrowPosition(Resultat, arrow);
        });
        
        bindButtonSelection(Resultat, arrow);
        bindButtonSelection(ListeRegime, arrow);
     ...
     ach.addActionListener((evt) -> {
           ...
           suivisRegime.setIduser(71); // variable session
