...
public class ModifierCommentaireForm extends BaseForm {
    ...
    Form current;
    public ModifierCommentaireForm(Resources res , Commentaire c) {
    ...
    //
     ...
     swipe.setUIID("Container");
       ...
       ajout.setUIID("SelectBar");
        ...
        TextField objet = new TextField(c.getType(), "", 20 , TextField.ANY);
        TextField description = new TextField(c.getContenu(), "" , 20 , TextField.ANY);
      ...
      //  etat.setSingleLineTextArea(true);
       ...
       btnModifier.addPointerPressedListener(l ->   { 
           ...
           c.setContenu(description.getText());
           c.setType(objet.getText());
