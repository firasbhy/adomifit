 ...
 * @author Kouki
 */
public class AjoutRegimeForm extends BaseForm {
      Form current;
      EncodedImage enc;
      Image imgs;
      ImageViewer imgv;
      
    AjoutRegimeForm(Resources res) {
      ...
      ButtonGroup barGroup = new ButtonGroup();
       ...
       partage.addActionListener(e-> new AjoutRegimeForm(res).show());
        ...
        addOrientationListener(e -> {
          ...
          TextField type = new TextField("", "entrer Type de régime!");
          ...
          TextField dificulte = new TextField("", "entrer Dificulté !");
          dificulte.setUIID("TextFieldBlack");
          addStringValue("Dificulté",dificulte);
        ...
        addStringValue("Sujet", SujetCombo);
          ...
          btnAjouter.addActionListener((e) -> {
              try {
                  if(type.getText() == "" ||description.getText() == "" ||dificulte.getText() == "" ){
                      ...
                      Regime reg = new Regime(String.valueOf(type.getText().toString()),
                      String.valueOf(description.getText().toString()),
                      String.valueOf(dificulte.getText().toString()),
                      String.valueOf(upimage.getText().toString()+ ".jpg") ,
                      Float.parseFloat(prix.getText().toString()),
                              //variable session SessionManager.getId()  ---> remplace 2
                     c.getId(),
                              71);
                      ...
                      //appel service 
                      serviceRegime.getInstance().addRegime(reg);
