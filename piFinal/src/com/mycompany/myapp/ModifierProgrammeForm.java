...
public class ModifierProgrammeForm extends BaseForm {
    ...
    public ModifierProgrammeForm(Resources res,Programme prog){
          ...
          getContentPane().setScrollVisible(false);
           ...
           TextField nom = new TextField(prog.getTitre(),"Titre",20,TextField.ANY);
           TextField description = new TextField(prog.getDescription(),"Description",20,TextField.ANY);
          ...
          Button btnUpload = new Button("Upload");
           ...
           btnModif.addPointerPressedListener((e) -> {
               prog.setTitre(nom.getText());
               prog.setDescription(description.getText());
               prog.setImage(upimage.getText().toString()+ ".jpg");
           ...
           if(serviceProgramme.getInstance().updateProduit(prog)){
